...
function MyLessonTiming(pVideo) {
  ...
  var setImage = function(pStart, pEnd, pTarget, pImage, pCaption, pClass, pLink) {
    pVideo.footnote({ start: pStart, end: pEnd, target: pTarget, text:
	  '<a class="lb_it cboxElement"><img class="lessonimages" src="' + pImage + '" alt=""><span>' + pCaption + '</span></img>'      
	  /*'<a href="' + pLink + '" target="_blank" class="' + pClass + '"><img class="lessonimages" src="' + pImage + '" alt=""><span>' + pCaption + '</span></img>'*/ /*+
 ...
 */
  ...
  pVideo.footnote({ start: video_start, end: step[1], target: "links", text:
    '<h2>Tutelage: Pot Pie History</h2>' +
	'<video id="vid_technique1" width="100%" height="auto" src="../video/kof5.mp4" controls>'/*onclick="techPlayPause(this)*/
	/*'<iframe width="270" height="200" src="http://www.youtube.com/v/qujO0Seagic&start=16" frameborder="0" allowfullscreen></iframe>' 
  ...
  // STEP 1
  setTool(      step[1], step[2], "knife",   "chef's knife",  "default","http://www.surlatable.com/product/PRO-673897/Shun-Premier-Chefs-Knife");
  setTool(      step[1], step[2], "board", "cutting board", "default","http://www.surlatable.com/product/PRO-1334/John-Boos-and-Co-Cutting-Board-with-Grips");
  pVideo.footnote({ start: step[1], end: step[3], target: "links", text:
    '<h2>Prep Tip: Mise en Place</h2>' +
	'<video id="vid_technique2" width="100%" height="auto" src="../video/kof9.mp4" controls>'
	/*'<iframe width="270" height="200" src="http://www.youtube.com/embed/PYf0kY0Rpxk" frameborder="0" allowfullscreen></iframe>' 
	'<a href="http://en.wikipedia.org/wiki/Mise_en_place" target="_blank">Wiki: mise-en-place</a><br/>' +
    '<a href="http://www.youtube.com/watch?v=yJEQFgfv7iw" target="_blank">How to Chiffonade</a><br/>' +
    '<a href="http://m.youtube.com/index?desktop_uri=%2F&gl=US#/watch?v=bjQ0GSSVymU" target="_blank">Pie Crust from Scratch</a><br/>' +
    '<a href="http://www.elledecor.com/elle-decor/articles/chicken-stock-recipes" target="_blank">Homemade Chicken Broth Recipe</a><br/>'*/ +
    ''
  });
  ...
  setIngredient(step[2], step[3], "pie_crust", "pie crust", "pie_crust","http://fresh.amazon.com/product?asin=B003D1Z2E2&qid=122887391&rank=1&sr=1-1&tag=title");
  setTool(      step[2], step[3], "plate", "pie plate", "pie_plate","http://www.surlatable.com/product/PRO-637231/Pyrex-Grip-Right-Pie-Plate");
 ...
 */
  ...
  pVideo.footnote({ start: step[3], end: step[4], target: "links", text:
    '<a href="http://sliceoflifesunday.wordpress.com/the-history-of-pie/" target="_blank">History of Pot Pie</a><br/>' +
    ''
  });
  ...
  pVideo.footnote({ start: step[4], end: step[7], target: "links", text:
    '<a href="http://www.skinnytaste.com/2011/01/chicken-pot-pie-soup.html" target="_blank">Skinny Taste: Chicken Pot Pie Soup</a><br/>' +
    '<a href="http://thehealthyfoodie.net/2011/12/29/chicken-pot-pie/" target="_blank">The Healthy Foody: Chicken Pot Pie</a><br/>' +
    '<a href="http://www.sheknows.com/food-and-recipes/articles/803945/healthy-chicken-pot-pie" target="_blank">She Knows: Healthy Chicken Pot Pie</a><br/>' +
    '<a href="http://www.cookingforengineers.com/recipe/42/Traditional-Chicken-Pot-Pie" target="_blank">Cooking for Engineers: Traditional Pot Pie</a><br/>' +
    ''
  });
  ...
  pVideo.footnote({ start: step[7], end: step[8], target: "links", text:
    '<a href="http://www.youtube.com/watch?v=zO5gsFKZoA8&feature=youtube_gdata_player" target="_blank">Fluting</a><br/>' +
    ''
  });
  ...
  pVideo.footnote({ start: step[8], end: step[9], target: "links", text:
    '<a href="http://www.amazon.com/Andersons-Baking-9-inch-Aluminum-Shield/dp/B0006GT4BY" target="_blank">Get your own Pie Shield</a><br/>' +
    ''
  });
  ...
  pVideo.footnote({ start: step[9], end: step[10], target: "links", text:
    '<a href="http://www.nytimes.com/2010/03/10/dining/10mini.htm" target="_blank">NYTimes: How to Top Chicken Pot Pie</a><br/>' +
    '<a href="http://www.huffingtonpost.com/mobileweb/2012/03/01/kfc-chunky-chicken-pot-pie_n_1312800.html" target="_blank">Huffington Post: KFC\'s Chunky Chicken Pot Pie</a><br/>' +
    '<a href="http://www.npr.org/templates/story/story.php?storyId=6949446" target="_blank">NPR: Pot Pie Reclaiming its place</a><br/>' +
    ''
  });
  ...
  pVideo.footnote({ start: step[10], end: bonus[2], target: "links", text:
    '<a href="http://seattlemag.com/article/dining/reviews/comfort-food-pot-pies" target="_blank">Seattle Mag</a><br/>' +
    '<a href="http://www.yelp.com/search?find_desc=chicken+pot+pie&find_loc=Seattle%2C+WA" target="_blank">Yelp</a><br/>' +
    '<a href="http://chowhound.chow.com/topics/378440" target="_blank">Chowhound</a><br/>' +
    ''
  });
  ...
  pVideo.footnote({ start: bonus[3], end: bonus[4], target: "links", text:
    '<a href="http://culinaryarts.about.com/od/knivescutlery/ss/anat-knife.htm" target="_blank">Anatomy of a Chef\'s Knife</a><br/>' +
    '<a href="http://www.foodnetwork.com/healthy-meal-makeover-chicken-pot-pie/package/index.html" target="_blank">Healthy Pot Pies</a><br/>' +
    '<a href="http://www.cookinglight.com/m/eating-smart/recipe-makeovers/healthy-chicken-potpie-recipes-00412000067896/" target="_blank">More Healthy Pot Pies</a><br/>' +
    ''
  });
  ...
  pVideo.footnote({ start: bonus[5], end: bonus[6], target: "links", text:
    ...
    '---The Art of Cookery Made Plain and Easy, Mrs. [Hannah] Glasse, a new Edition with modern Improvements, facsimile 1805 edition printed by Cottom and Stewart and sold at their Book-Stores in Alexandria and Fredericksburg 1805, introduction by Karen Hess [Applewood Books:Bedford MA] 1997 (p. 144)<br/>' +
    ''
  });
  ...
  pVideo.footnote({ start: bonus[8], end: bonus[9], target: "links", text:
    ...
    '<br/>'+
    '<h1>1877</h1><br/>' +
    '<a href="http://digital.lib.msu.edu/projects/cookbooks/display.cfm?TitleNo=40&PageNum=249" target="_blank">Chicken pot pie</a>, Buckeye Cookery, Estelle Woods Wilcox<br/>' +
    ''
  });
