...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('app_profile', 'video',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='profiles', null=True, to=orm['app.Video']),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Profile.video'
        db.delete_column('app_profile', 'video_id')
