...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'FeaturedChef.intro_text'
        db.delete_column('app_featuredchef', 'intro_text')

        # Deleting field 'FeaturedChef.intro_video'
        db.delete_column('app_featuredchef', 'intro_video')
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'FeaturedChef.intro_text'
        raise RuntimeError("Cannot reverse this migration. 'FeaturedChef.intro_text' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'FeaturedChef.intro_video'
        raise RuntimeError("Cannot reverse this migration. 'FeaturedChef.intro_video' and its values cannot be restored.")
