...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Tool.image'
        db.add_column('app_tool', 'image',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Tool.category'
        db.add_column('app_tool', 'category',
                      self.gf('django.db.models.fields.CharField')(max_length=32, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Tool.description'
        db.add_column('app_tool', 'description',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Tool.substitution1'
        db.add_column('app_tool', 'substitution1',
                      self.gf('django.db.models.fields.CharField')(max_length=32, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Tool.substitution2'
        db.add_column('app_tool', 'substitution2',
                      self.gf('django.db.models.fields.CharField')(max_length=32, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Tool.product_link'
        db.add_column('app_tool', 'product_link',
                      self.gf('django.db.models.fields.URLField')(max_length=255, null=True, blank=True),
                      keep_default=False)


        # Changing field 'Tool.type'
        db.alter_column('app_tool', 'type', self.gf('django.db.models.fields.CharField')(max_length=32, null=True))

        # Changing field 'Tool.size'
        db.alter_column('app_tool', 'size', self.gf('django.db.models.fields.CharField')(max_length=32, null=True))
        # Adding field 'Ingredient.category'
        db.add_column('app_ingredient', 'category',
                      self.gf('django.db.models.fields.CharField')(max_length=32, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Ingredient.description'
        db.add_column('app_ingredient', 'description',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Ingredient.substitution1'
        db.add_column('app_ingredient', 'substitution1',
                      self.gf('django.db.models.fields.CharField')(max_length=32, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Ingredient.substitution2'
        db.add_column('app_ingredient', 'substitution2',
                      self.gf('django.db.models.fields.CharField')(max_length=32, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Ingredient.product_link'
        db.add_column('app_ingredient', 'product_link',
                      self.gf('django.db.models.fields.URLField')(max_length=255, null=True, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Tool.image'
        db.delete_column('app_tool', 'image')

        # Deleting field 'Tool.category'
        db.delete_column('app_tool', 'category')

        # Deleting field 'Tool.description'
        db.delete_column('app_tool', 'description')

        # Deleting field 'Tool.substitution1'
        db.delete_column('app_tool', 'substitution1')

        # Deleting field 'Tool.substitution2'
        db.delete_column('app_tool', 'substitution2')

        # Deleting field 'Tool.product_link'
        db.delete_column('app_tool', 'product_link')


        # Changing field 'Tool.type'
        db.alter_column('app_tool', 'type', self.gf('django.db.models.fields.CharField')(max_length=32))

        # Changing field 'Tool.size'
        db.alter_column('app_tool', 'size', self.gf('django.db.models.fields.CharField')(max_length=32))
        # Deleting field 'Ingredient.category'
        db.delete_column('app_ingredient', 'category')

        # Deleting field 'Ingredient.description'
        db.delete_column('app_ingredient', 'description')

        # Deleting field 'Ingredient.substitution1'
        db.delete_column('app_ingredient', 'substitution1')

        # Deleting field 'Ingredient.substitution2'
        db.delete_column('app_ingredient', 'substitution2')

        # Deleting field 'Ingredient.product_link'
        db.delete_column('app_ingredient', 'product_link')
    ...
    models = {
        ...
        'app.chefpledge': {
            ...
            'amount_required': ('app.models.CurrencyField', [], {'max_digits': '7', 'decimal_places': '5'}),
            'created_on': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'app.lessonpledge': {
            ...
            'amount': ('app.models.CurrencyField', [], {'max_digits': '7', 'decimal_places': '5'}),
            'created_on': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
