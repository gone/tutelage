...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'HomeBlock.body'
        db.alter_column('app_homeblock', 'body', self.gf('mezzanine.core.fields.RichTextField')())

        # Changing field 'Home.call_to_action'
        db.alter_column('app_home', 'call_to_action', self.gf('mezzanine.core.fields.RichTextField')())
    def backwards(self, orm):
        ...
        # Changing field 'HomeBlock.body'
        db.alter_column('app_homeblock', 'body', self.gf('django.db.models.fields.TextField')())

        # Changing field 'Home.call_to_action'
        db.alter_column('app_home', 'call_to_action', self.gf('django.db.models.fields.TextField')())
    models = {
        'app.about': {
