...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Profile.testimonial1_link'
        db.add_column('app_profile', 'testimonial1_link',
        ...
        # Adding field 'Profile.testimonial2_link'
        db.add_column('app_profile', 'testimonial2_link',
                      self.gf('django.db.models.fields.URLField')(default='', max_length=255, blank=True),
                      keep_default=False)
        ...
        # Adding field 'Profile.testimonial3_link'
        db.add_column('app_profile', 'testimonial3_link',
                      self.gf('django.db.models.fields.URLField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'Profile.personal_video'
        db.add_column('app_profile', 'personal_video',
                      self.gf('django.db.models.fields.files.FileField')(default='', max_length=100),
                      keep_default=False)

        # Adding field 'Profile.personal_video_image'
        db.add_column('app_profile', 'personal_video_image',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Profile.testimonial1_link'
        db.delete_column('app_profile', 'testimonial1_link')
        ...
        # Deleting field 'Profile.testimonial2_link'
        db.delete_column('app_profile', 'testimonial2_link')
        ...
        # Deleting field 'Profile.testimonial3_link'
        db.delete_column('app_profile', 'testimonial3_link')

        # Deleting field 'Profile.personal_video'
        db.delete_column('app_profile', 'personal_video')

        # Deleting field 'Profile.personal_video_image'
        db.delete_column('app_profile', 'personal_video_image')
    ...
    models = {
        ...
        'app.profile': {
            ...
            'personal_video': ('django.db.models.fields.files.FileField', [], {'max_length': '100'}),
            'personal_video_image': ('django.db.models.fields.files.ImageField', [], {'max_length': '100'}),
