...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'FeaturedChef.page_ptr'
        db.delete_column('app_featuredchef', 'page_ptr_id')

        # Adding field 'FeaturedChef.id'
        db.add_column('app_featuredchef', 'id',
                      self.gf('django.db.models.fields.AutoField')(default=0, primary_key=True, blank=True, null=True,),
                      keep_default=False)
        ...
        db.add_column('app_featuredchef', 'slug',
                      self.gf('django.db.models.fields.CharField')(max_length=2000, null=True, blank=True),
                      keep_default=False)

        # Adding field 'FeaturedChef._meta_title'
        db.add_column('app_featuredchef', '_meta_title',
                      self.gf('django.db.models.fields.CharField')(max_length=500, null=True, blank=True),
                      keep_default=False)

        # Adding field 'FeaturedChef.description'
        db.add_column('app_featuredchef', 'description',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'FeaturedChef.gen_description'
        db.add_column('app_featuredchef', 'gen_description',
        ...
        db.add_column('app_featuredchef', 'publish_date',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'FeaturedChef.expiry_date'
        db.add_column('app_featuredchef', 'expiry_date',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'FeaturedChef.short_url'
        db.add_column('app_featuredchef', 'short_url',
                      self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True),
                      keep_default=False)

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'FeaturedChef.page_ptr'
        raise RuntimeError("Cannot reverse this migration. 'FeaturedChef.page_ptr' and its values cannot be restored.")
        # Deleting field 'FeaturedChef.id'
        db.delete_column('app_featuredchef', 'id')

        # Deleting field 'FeaturedChef.keywords_string'
        db.delete_column('app_featuredchef', 'keywords_string')

        # Deleting field 'FeaturedChef.site'
        db.delete_column('app_featuredchef', 'site_id')

        # Deleting field 'FeaturedChef.title'
        db.delete_column('app_featuredchef', 'title')

        # Deleting field 'FeaturedChef.slug'
        db.delete_column('app_featuredchef', 'slug')

        # Deleting field 'FeaturedChef._meta_title'
        db.delete_column('app_featuredchef', '_meta_title')

        # Deleting field 'FeaturedChef.description'
        db.delete_column('app_featuredchef', 'description')

        # Deleting field 'FeaturedChef.gen_description'
        db.delete_column('app_featuredchef', 'gen_description')

        # Deleting field 'FeaturedChef.status'
        db.delete_column('app_featuredchef', 'status')

        # Deleting field 'FeaturedChef.publish_date'
        db.delete_column('app_featuredchef', 'publish_date')

        # Deleting field 'FeaturedChef.expiry_date'
        db.delete_column('app_featuredchef', 'expiry_date')

        # Deleting field 'FeaturedChef.short_url'
        db.delete_column('app_featuredchef', 'short_url')
