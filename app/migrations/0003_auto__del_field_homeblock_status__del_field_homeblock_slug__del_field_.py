...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'HomeBlock.status'
        db.delete_column('app_homeblock', 'status')

        # Deleting field 'HomeBlock.slug'
        db.delete_column('app_homeblock', 'slug')

        # Deleting field 'HomeBlock.description'
        db.delete_column('app_homeblock', 'description')

        # Deleting field 'HomeBlock.site'
        db.delete_column('app_homeblock', 'site_id')

        # Deleting field 'HomeBlock.short_url'
        db.delete_column('app_homeblock', 'short_url')

        # Deleting field 'HomeBlock.title'
        db.delete_column('app_homeblock', 'title')

        # Deleting field 'HomeBlock.keywords_string'
        db.delete_column('app_homeblock', 'keywords_string')

        # Deleting field 'HomeBlock._meta_title'
        db.delete_column('app_homeblock', '_meta_title')

        # Deleting field 'HomeBlock.publish_date'
        db.delete_column('app_homeblock', 'publish_date')

        # Deleting field 'HomeBlock.gen_description'
        db.delete_column('app_homeblock', 'gen_description')

        # Deleting field 'HomeBlock.expiry_date'
        db.delete_column('app_homeblock', 'expiry_date')

    def backwards(self, orm):
        # Adding field 'HomeBlock.status'
        db.add_column('app_homeblock', 'status',
                      self.gf('django.db.models.fields.IntegerField')(default=2),
                      keep_default=False)

        # Adding field 'HomeBlock.slug'
        db.add_column('app_homeblock', 'slug',
                      self.gf('django.db.models.fields.CharField')(max_length=2000, null=True, blank=True),
                      keep_default=False)

        # Adding field 'HomeBlock.description'
        db.add_column('app_homeblock', 'description',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'HomeBlock.site'
        db.add_column('app_homeblock', 'site',
                      self.gf('django.db.models.fields.related.ForeignKey')(default='', to=orm['sites.Site']),
                      keep_default=False)

        # Adding field 'HomeBlock.short_url'
        db.add_column('app_homeblock', 'short_url',
                      self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Adding field 'HomeBlock.title'
        db.add_column('app_homeblock', 'title',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=500),
                      keep_default=False)

        # Adding field 'HomeBlock.keywords_string'
        db.add_column('app_homeblock', 'keywords_string',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=500, blank=True),
                      keep_default=False)

        # Adding field 'HomeBlock._meta_title'
        db.add_column('app_homeblock', '_meta_title',
                      self.gf('django.db.models.fields.CharField')(max_length=500, null=True, blank=True),
                      keep_default=False)

        # Adding field 'HomeBlock.publish_date'
        db.add_column('app_homeblock', 'publish_date',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'HomeBlock.gen_description'
        db.add_column('app_homeblock', 'gen_description',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'HomeBlock.expiry_date'
        db.add_column('app_homeblock', 'expiry_date',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)
