...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('app_chefpledge', 'amount_required', self.gf('app.models.CurrencyField')(max_digits=7, decimal_places=2))

        # Changing field 'LessonPledge.amount'
        db.alter_column('app_lessonpledge', 'amount', self.gf('app.models.CurrencyField')(max_digits=7, decimal_places=2))
