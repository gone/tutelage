...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Lesson.recipie'
        db.add_column('app_lesson', 'recipie',
                      self.gf('django.db.models.fields.related.ForeignKey')(default='', related_name='lessons', to=orm['app.Recipie']),
                      keep_default=False)
