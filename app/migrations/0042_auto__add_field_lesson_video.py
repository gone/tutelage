...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('app_lesson', 'video',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='lesson', null=True, to=orm['app.Video']),
                      keep_default=False)

        # Removing M2M table for field videos on 'Lesson'
        db.delete_table('app_lesson_videos')

    def backwards(self, orm):
        # Deleting field 'Lesson.video'
        db.delete_column('app_lesson', 'video_id')

        # Adding M2M table for field videos on 'Lesson'
        db.create_table('app_lesson_videos', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('lesson', models.ForeignKey(orm['app.lesson'], null=False)),
            ('video', models.ForeignKey(orm['app.video'], null=False))
        ))
        db.create_unique('app_lesson_videos', ['lesson_id', 'video_id'])
    ...
    models = {
        ...
        'app.lesson': {
            ...
            'video': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'lesson'", 'null': 'True', 'to': "orm['app.Video']"})
        },
        ...
        'app.step': {
            ...
            'technique': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'technique'", 'null': 'True', 'to': "orm['app.Lesson']"}),
