...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('app_lessontool', (
            ...
            ('tool', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['app.Tool'])),
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'Tool.type'
        raise RuntimeError("Cannot reverse this migration. 'Tool.type' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'Tool.size'
        raise RuntimeError("Cannot reverse this migration. 'Tool.size' and its values cannot be restored.")
    ...
    models = {
        ...
        'app.lesson': {
            ...
            'tools': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'lessons'", 'symmetrical': 'False', 'through': "orm['app.LessonTool']", 'to': "orm['app.Tool']"}),
            'updated_on': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
        ...
        'app.lessontool': {
            ...
            'tool': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['app.Tool']"}),
