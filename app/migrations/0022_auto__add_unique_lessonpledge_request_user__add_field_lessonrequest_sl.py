...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'LessonPledge', fields ['request', 'user']
        db.create_unique('app_lessonpledge', ['request_id', 'user_id'])

        # Adding field 'LessonRequest.slug'
        db.add_column('app_lessonrequest', 'slug',
                      self.gf('django.db.models.fields.SlugField')(default='', max_length=50),
                      keep_default=False)

    def backwards(self, orm):
        # Removing unique constraint on 'LessonPledge', fields ['request', 'user']
        db.delete_unique('app_lessonpledge', ['request_id', 'user_id'])

        # Deleting field 'LessonRequest.slug'
        db.delete_column('app_lessonrequest', 'slug')
