...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'DietaryRestrictions.restrcition'
        db.delete_column('app_dietaryrestrictions', 'restrcition')

        # Adding field 'DietaryRestrictions.restriction'
        db.add_column('app_dietaryrestrictions', 'restriction',
    ...
    def backwards(self, orm):
        # Adding field 'DietaryRestrictions.restrcition'
        db.add_column('app_dietaryrestrictions', 'restrcition',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=256),
                      keep_default=False)

        # Deleting field 'DietaryRestrictions.restriction'
        db.delete_column('app_dietaryrestrictions', 'restriction')
