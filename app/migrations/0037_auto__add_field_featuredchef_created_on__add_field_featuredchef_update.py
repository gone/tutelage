...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FeaturedChef.created_on'
        db.add_column('app_featuredchef', 'created_on',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2013, 3, 9, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'FeaturedChef.updated_on'
        db.add_column('app_featuredchef', 'updated_on',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2013, 3, 9, 0, 0), blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'FeaturedChef.created_on'
        db.delete_column('app_featuredchef', 'created_on')

        # Deleting field 'FeaturedChef.updated_on'
        db.delete_column('app_featuredchef', 'updated_on')
