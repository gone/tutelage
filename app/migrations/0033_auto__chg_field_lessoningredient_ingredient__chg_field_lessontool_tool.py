...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'LessonIngredient.ingredient'
        db.alter_column('app_lessoningredient', 'ingredient_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['app.Ingredient'], null=True, on_delete=models.SET_NULL))

        # Changing field 'LessonTool.tool'
        db.alter_column('app_lessontool', 'tool_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['app.Tool'], null=True, on_delete=models.SET_NULL))
    def backwards(self, orm):

        # Changing field 'LessonIngredient.ingredient'
        db.alter_column('app_lessoningredient', 'ingredient_id', self.gf('django.db.models.fields.related.ForeignKey')(default='Fruit', to=orm['app.Ingredient']))

        # Changing field 'LessonTool.tool'
        db.alter_column('app_lessontool', 'tool_id', self.gf('django.db.models.fields.related.ForeignKey')(default='Knives', to=orm['app.Tool']))
    models = {
        'app.about': {
