...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Lesson.user'
        db.delete_column('app_lesson', 'user_id')

        # Adding field 'Lesson.teacher'
        db.add_column('app_lesson', 'teacher',
                      self.gf('django.db.models.fields.related.ForeignKey')(default='', related_name='lessons_teaching', to=orm['auth.User']),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Adding field 'Lesson.user'
        db.add_column('app_lesson', 'user',
                      self.gf('django.db.models.fields.related.ForeignKey')(default='', related_name='lessons_teaching', to=orm['auth.User']),
                      keep_default=False)

        # Deleting field 'Lesson.teacher'
        db.delete_column('app_lesson', 'teacher_id')
