...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'UserSignupRequest'
        db.create_table('app_usersignuprequest', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created_on', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('updated_on', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('email', self.gf('django.db.models.fields.EmailField')(max_length=256)),
            ('invite_date', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, blank=True)),
        ))
        db.send_create_signal('app', ['UserSignupRequest'])

    def backwards(self, orm):
        # Deleting model 'UserSignupRequest'
        db.delete_table('app_usersignuprequest')
