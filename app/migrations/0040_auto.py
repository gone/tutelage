...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing M2M table for field video on 'Lesson'
        db.delete_table('app_lesson_video')
    ...
    def backwards(self, orm):
        # Adding M2M table for field video on 'Lesson'
        db.create_table('app_lesson_video', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('lesson', models.ForeignKey(orm['app.lesson'], null=False)),
            ('video', models.ForeignKey(orm['app.video'], null=False))
        ))
        db.create_unique('app_lesson_video', ['lesson_id', 'video_id'])
    ...
    models = {
        ...
        'app.lesson': {
            ...
            'videos': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'lessons'", 'symmetrical': 'False', 'to': "orm['app.Video']"})
        },
