...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'FeaturedChef.hero'
        db.delete_column('app_featuredchef', 'hero')

        # Adding field 'FeaturedChef.intro_video'
        db.add_column('app_featuredchef', 'intro_video',
                      self.gf('django.db.models.fields.files.ImageField')(default='', max_length=100),
                      keep_default=False)

    def backwards(self, orm):
        # Adding field 'FeaturedChef.hero'
        db.add_column('app_featuredchef', 'hero',
                      self.gf('django.db.models.fields.files.ImageField')(default='', max_length=100),
                      keep_default=False)
