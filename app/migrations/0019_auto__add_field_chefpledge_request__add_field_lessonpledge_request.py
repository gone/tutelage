...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ChefPledge.request'
        db.add_column('app_chefpledge', 'request',
                      self.gf('django.db.models.fields.related.ForeignKey')(default='', to=orm['app.LessonRequest']),
                      keep_default=False)

        # Adding field 'LessonPledge.request'
        db.add_column('app_lessonpledge', 'request',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['app.LessonRequest']),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'ChefPledge.request'
        db.delete_column('app_chefpledge', 'request_id')

        # Deleting field 'LessonPledge.request'
        db.delete_column('app_lessonpledge', 'request_id')
    ...
    models = {
        ...
        'app.chefpledge': {
            ...
            'created_on': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'request': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['app.LessonRequest']"}),
            'updated_on': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
