...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('app_lessontool', (
            ...
            ('name', self.gf('django.db.models.fields.CharField')(default='tool', max_length=32)),
        ...
        # Adding field 'LessonIngredient.name'
        db.add_column('app_lessoningredient', 'name',
                      self.gf('django.db.models.fields.CharField')(default='ingredient', max_length=32),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'LessonIngredient.name'
        db.delete_column('app_lessoningredient', 'name')
    ...
    models = {
        ...
        'app.lessoningredient': {
            ...
            'name': ('django.db.models.fields.CharField', [], {'default': "'ingredient'", 'max_length': '32'}),
        ...
        'app.lessontool': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'lesson': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['app.Lesson']"}),
            'name': ('django.db.models.fields.CharField', [], {'default': "'tool'", 'max_length': '32'}),
