...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ChefPledge.amount_required'
        db.alter_column('app_chefpledge', 'amount_required', self.gf('app.models.CurrencyField')(max_digits=7, decimal_places=5))
        # Adding field 'LessonPledge.date_pledged'
        db.add_column('app_lessonpledge', 'date_pledged',
                      self.gf('django.db.models.fields.DateField')(auto_now_add=True, default='2012-12-11', blank=True),
                      keep_default=False)


        # Changing field 'LessonPledge.amount'
        db.alter_column('app_lessonpledge', 'amount', self.gf('app.models.CurrencyField')(max_digits=7, decimal_places=5))
    def backwards(self, orm):

        # Changing field 'ChefPledge.amount_required'
        db.alter_column('app_chefpledge', 'amount_required', self.gf('app.models.CurrencyField')(max_digits=4, decimal_places=2))
        # Deleting field 'LessonPledge.date_pledged'
        db.delete_column('app_lessonpledge', 'date_pledged')


        # Changing field 'LessonPledge.amount'
        db.alter_column('app_lessonpledge', 'amount', self.gf('app.models.CurrencyField')(max_digits=4, decimal_places=2))
    models = {
        'app.about': {
