...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Step.technique'
        db.add_column('app_step', 'technique',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='technique', null=True, to=orm['app.Lesson']),
                      keep_default=False)
    ...
    def backwards(self, orm):
        # Deleting field 'Step.technique'
        db.delete_column('app_step', 'technique_id')
